...
class Solution {
    public void solution(String[] arr1, String[] arr2) {
        ...
        OutputView.print(list.size());
        OutputView.printStringArray(list);
    }
}
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] strarr1 = InputView.readStringArray(N[0]);
        String[] strarr2 = InputView.readStringArray(N[1]);

        solution.solution(strarr1, strarr2);
